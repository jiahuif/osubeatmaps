...
class BeatmapCrawler:
    ...
    def login(self, username=None, password=None):
        ...
        self.session.post(form[0].action, post_form, headers={'Referer': "https://osu.ppy.sh/"})
    ...
    def download_beatmap(self, beatmap_id):
        ...
        response = self.session.get(url, stream=True, headers={'Referer': "https://osu.ppy.sh/d/%d" % beatmap_id})
